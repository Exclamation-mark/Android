...
//        xAxis.setGridColor(Color.parseColor("#30FFFFFF"));
        xAxis.setGridColor(Color.parseColor("#300A0A0A"));
        // 设置x轴数据偏移量
        xAxis.setYOffset(-10);
    ...
    public static void setChartData(LineChart chart, List<Entry> values) {
        ...
        if (chart.getData() != null && chart.getData().getDataSetCount() > 0) {
            ...
            // 设置曲线颜色
            lineDataSet.setColor(Color.parseColor("#0A0A0A"));
            // 设置平滑曲线
     ...
     * @param chart     图表
     * @param values    数据
     * @param valueType 数据类型, List<Entry> values
     */
    public static void notifyDataSetChanged(LineChart chart) {
