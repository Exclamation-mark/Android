...
import com.xiaocool.sugarangel.bean.ChatModel;
import com.xiaocool.sugarangel.bean.ItemModel;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.BaseAdapter> {
    ...
    private class ChatAViewHolder extends BaseAdapter {
        ...
        void setData(Object object) {
            ...
            GlideUtils.loadImageView(itemView.getContext(),model.getIcon(),ic_user);
