...
import com.xiaocool.sugarangel.acyivity.BindDeviceActivity;

import java.util.ArrayList;

public class DevicesListAdapter extends BaseAdapter {
	private ArrayList<BindDeviceActivity.SiriListItem> list;
    private LayoutInflater mInflater;
  
    public DevicesListAdapter(Context context, ArrayList<BindDeviceActivity.SiriListItem> list2) {
    	list = list2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BindDeviceActivity.SiriListItem item=list.get(position);
        if(convertView == null){
