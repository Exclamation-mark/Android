...
import com.xiaocool.sugarangel.adapter.DevicesListAdapter;
        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            StopDialog.setPositiveButton("连接", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Sn_MainHandler.cancelSearch();
                    Sn_MainHandler.connectBlueTooth(item.info.getDevice(), new SC_BlueToothCallBack() {

                        @Override
                        public void onConnectFeedBack(int result) {
                            // TODO Auto-generated method stub
                            Intent intent = getIntent();
                            String uuid = item.info.getDevice().getAddress().replaceAll(":", "");
